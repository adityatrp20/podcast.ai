...
const RightSidebar = () => {
  ...
  return (
    <section className='riggt_sidebar text-white-1'>
      <SignedIn>
      ...
      <section>
        <Header headerTitle='Fans Link You' />
        <Carousel fansLikeDetail={topPodcasters!} />
      </section>
      <section className='flex flex-col gap-8 pt-12'>
        <Header headerTitle='Top Podcasters' />
        <div className='flex felx-col hap-6'>
          {topPodcasters?.slice(0,4).map((podcaster) => (
            ...
            >
              <figure className='flex items-center gap-2'>
                ...
                />
                <h2 className='text-14 text-semibold text-white-1'>{podcaster.name}</h2>
              </figure>
